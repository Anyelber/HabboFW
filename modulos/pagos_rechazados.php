...
if(!is_admin_or_more(rol($_SESSION['id']))){
    ...
    $q1 = $pdo->prepare("SELECT fecha FROM pagas WHERE status = 0 ORDER BY id ASC LIMIT 1");
    $q2 = $pdo->prepare("SELECT fecha FROM pagas WHERE status = 0 ORDER BY id DESC LIMIT 1");
